...
### Código Python
- `neural_ancestry_predictor_deprecated/verify_processed_dataset.py`
...
2. `neural_ancestry_predictor_deprecated/verify_processed_dataset.py` → **Lê** `ontology_details` ✅
