...
def load_combined_rna_seq(cache_dir: Path, gene: str, sample_id: str):
    """Loads and sums a cached (H1 + H2) RNA-seq track for one individual, generated by
    `generate_predictions`/`predict_haplotype` above."""
    npz_h1, meta_h1 = prediction_paths(cache_dir, gene, sample_id, "H1")
    npz_h2, meta_h2 = prediction_paths(cache_dir, gene, sample_id, "H2")
    h1 = load_rna_seq(npz_h1, meta_h1)
    h2 = load_rna_seq(npz_h2, meta_h2)
    return h1 + h2
