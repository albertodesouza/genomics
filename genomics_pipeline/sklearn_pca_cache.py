...
CLI (após o cache do dataset existir):
    python3 -m genomics_pipeline.sklearn_pca_cache --config configs/genes_1000.yaml
    python3 -m genomics_pipeline.sklearn_pca_cache --config configs/genes_1000.yaml --force
"""
...
def _load_neural_ancestry_predictor_deprecated_module():
    ...
    nap_path = repo_root / "neural_ancestry_predictor_deprecated" / "neural_ancestry_predictor_deprecated.py"
