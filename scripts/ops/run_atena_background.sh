#!/bin/bash
# run_atena_background.sh - Script para executar pipeline em background na máquina atena

#set -euo pipefail

# Configurações
CONFIG="config_human_30x_atena.yaml"
LOG_FILE="pipeline_atena_$(date +%Y%m%d_%H%M%S).log"
PID_FILE="pipeline_atena.pid"

echo "🚀 Preparando execução em background na máquina atena (128 cores + 256GB RAM)"
echo "📋 Config: $CONFIG"
echo "📝 Log: $LOG_FILE"
...
echo ""
echo "🎯 Configuração atena 256GB ativa:"
