...
# Uso:  source scripts/maintenance/vep_install.sh
#       source scripts/maintenance/vep_install.sh [BRANCH]   (ex: release/114)
#
...
if [ -z "${CONDA_DEFAULT_ENV:-}" ]; then
    ...
    echo "💡 Execute: source scripts/env/start_genomics_universal.sh"
