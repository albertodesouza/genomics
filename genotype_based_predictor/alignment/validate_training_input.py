...
from genotype_based_predictor.alignment.bcftools_chain_mapper import BcftoolsChainMapper, read_fasta_sequence
from genotype_based_predictor.config import PipelineConfig, load_config
from genotype_based_predictor.data.processed_dataset import ProcessedGenomicDataset
from genotype_based_predictor.alignment.dynamic_indel_alignment import DynamicIndelAligner
from genotype_based_predictor.data.genomic_dataset import GenomicDataset
...
def _validate_haplotype(
    *,
    ...
    required = [case_dir / "ref.window.fa", fixed_path, raw_path, vcf_path]
