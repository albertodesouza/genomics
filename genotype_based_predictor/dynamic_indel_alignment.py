...
class DynamicIndelAligner:
    ...
    def __init__(
        ...
        self.persistent_cache_root = Path(persistent_cache_dir) if persistent_cache_dir else self.dataset_dir / "alignment_cache" / ALIGNMENT_ALGORITHM_VERSION
    ...
    def _gene_cache_dir(self, gene_name: str) -> Path:
        return self.persistent_cache_root / self._sample_set_key() / gene_name
