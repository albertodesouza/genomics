...
genomics alphagenome chr15-local --config configs/workflows/alphagenome/chr15_local.yaml --sample HG00096 --ref-fasta /dados/GENOMICS_DATA/top3/refs/GRCh38_full_analysis_set_plus_decoy_hla.fa --vcf /path/to/chr15.vcf.gz --outputs RNA_SEQ --max-windows 1 --haplotype H1 --strand plus
```
