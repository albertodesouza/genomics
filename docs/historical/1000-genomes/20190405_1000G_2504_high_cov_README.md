...
Initial analysis has been done by NYGC, including aligning the data to GRCh38, creating the CRAMs in ENA. The document [NYGC_b38_pipeline_description.pdf](20190405_NYGC_b38_pipeline_description.pdf) contains a description of that analysis work and details of the alignment pipeline.
