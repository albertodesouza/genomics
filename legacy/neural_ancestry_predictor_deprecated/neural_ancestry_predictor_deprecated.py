...
if _mpl:
    ...
    try:
        matplotlib.use("TkAgg")
            ...
            matplotlib.use("Agg")
from genomics.core import set_random_seeds, update_manifest
...
def main():
    ...
    console.print(
        ...
        "Use `genomics genotype train configs/predictors/genotype_based/neural_legacy/genes_1000_all.yaml` "
        "or another genotype config for new runs."
    )
