...
# Importar funções de normalização do neural_ancestry_predictor_deprecated
sys.path.insert(0, str(Path(__file__).parent))
from neural_ancestry_predictor_deprecated import log_normalize, minmax_keep_zero
...
def save_figure_to_images(
    ...
    """
    Save figure to the images/ directory in neural_ancestry_predictor_deprecated.
...
class InteractiveComparisonViewer:
    ...
    def __init__(self, config: Dict, splits_data: Dict, dataset_metadata: Dict, 
        ...
        if not self.available_genes:
            ...
            console.print("[cyan]Execute: genomics dataset-builders non-longevous build --config <seu_config.yaml>[/cyan]")
...
def _load_from_files(
    ...
    for gene_name in genes_to_load:
        ...
        # (mesmo método usado em neural_ancestry_predictor_deprecated.py)
