...
Input directory is fixed to:
  /home/lume2/genomics/neural_ancestry_predictor_deprecated/top_regions_reports_central2
...
DEFAULT_INPUT_DIR = Path("/home/lume2/genomics/neural_ancestry_predictor_deprecated/top_regions_reports_central2")
...
def main() -> int:
    ...
    lines.append(
        ...
        "using AlphaGenome outputs processed by `neural_ancestry_predictor_deprecated.py` and `annotate_deeplift_windows.py`.\"*\n\n"
    )
