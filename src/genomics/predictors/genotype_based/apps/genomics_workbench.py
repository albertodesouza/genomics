...
def _build_specs(args: argparse.Namespace) -> List[ViewerSpec]:
    ...
    specs = [
        ViewerSpec(
            ...
            module="genomics.predictors.genotype_based.apps.dataset_browser",
        ...
        ViewerSpec(
            ...
            module="genomics.predictors.genotype_based.apps.view_builder",
        ...
        ViewerSpec(
            ...
            module="genomics.predictors.genotype_based.apps.experiment_dashboard",
        ...
        ViewerSpec(
            ...
            module="genomics.predictors.genotype_based.apps.alphagenome_track_viewer",
        ...
        ViewerSpec(
            ...
            module="genomics.predictors.genotype_based.apps.aligned_dna_viewer",
